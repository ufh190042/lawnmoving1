...
function tempahan_borang_custom_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'Senarai Pendaftaran ', 'text_domain' ),
		'labels'                => $labels,
...
function stk_meta_box_add()
{
    ...
    add_meta_box( 'section_c', 'Anggaran Pengiraan Kos', 'stk_metabox_sc', 'borang-stk', 'normal', 'default' );
		...
		//Section D - Keputusan Pendaftaran//
	add_meta_box( 'section_e', 'Keputusan Pendaftaran', 'stk_metabox_se', 'borang-stk', 'normal', 'default' );
}
